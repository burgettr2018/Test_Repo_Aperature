Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    # Example implementation:
       ...
       #http://stackoverflow.com/questions/14504739/how-to-use-both-devise-and-doorkeeper-gems
    ...
    # if current_user.company_users.count > 1
    #   if session[:current_company].blank?
    #     redirect_to
    #   end
    #
    # end
